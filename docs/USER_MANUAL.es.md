...
Si hay una grabación en curso, MeetsVault muestra un cuadro de confirmación — elige **Stop** para detener y transcribir, o **Continue** para seguir grabando. Si no hay nada grabándose, la URL se ignora.
